/*
 * FrequencyDomainConvolverO3.cpp
 *
...
FrequencyDomainConvolverO3::FrequencyDomainConvolverO3() {
...
AudioFile *FrequencyDomainConvolverO3::convolve(AudioFile *dryFile, AudioFile *irFile) {
...
double *FrequencyDomainConvolverO3::vectorOfNormalToArrayOfComplex(std::vector<double> input) {
...
void FrequencyDomainConvolverO3::fft(double *data, int nn, int isign) {
...
int FrequencyDomainConvolverO3::closestPowerOfTwo(int N, int M) {
	int k = std::max(N, M);
	if (k <= 2) return 2;
	if (k <= 4) return 4;
	if (k <= 8) return 8;
...
double *FrequencyDomainConvolverO3::zeroPad(double *array, int currentSize, int wantedSize) {
